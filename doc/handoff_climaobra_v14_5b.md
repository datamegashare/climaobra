...
─── ARCHIVOS EN PRODUCCIÓN ───────────────────────────────────────────
  clima_v13_10.gs    → GAS backend (en producción desde esta sesión)
  index_v14_5.html   → Frontend PWA (en producción, sin cambios esta sesión)
...
─── CREDENCIALES ─────────────────────────────────────────────────────
  ...
  VERSION_UI  = 'v14.5' (constante JS en index.html — sin cambios esta sesión)
  VERSION_GAS = 'v13.10' (GAS en producción)
...
─── REGLAS DE ENTREGA ────────────────────────────────────────────────
  ...
  - Nombre de archivo siempre incluye versión: clima_v13_10.gs
...
- ✅ Hoja Registros_OM con datos — 11/05 recuperado manualmente con opción 7d
