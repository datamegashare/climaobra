// ============================================================
//  CLIMAOBRA  v13.0  —  Integración Open-Meteo (hoja Registros_OM)
...
// ─────────────────────────────────────────────────────────────
//  getDashboardDataOM — igual que getDashboardData pero lee
...
function getDashboardDataOM(obraId) {
  ...
  return { version: VERSION_GAS, obra, ultimo, dias: ultimos28, anual, ultimoDia, uptime60, fuente: 'open-meteo' };
}
